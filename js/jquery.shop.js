(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.currency = "SEK"; // HTML entity of the currency to be displayed in the layout
			this.currencyString = "SEK"; // Currency symbol as textual string
			this.paypalCurrency = "SEK"; // PayPal's currency code
			this.paypalBusinessEmail = "dennis_nilsson_@live.se"; // Your Business PayPal's account email address
